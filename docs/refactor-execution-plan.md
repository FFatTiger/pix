...
| `C1` | RuntimeSocket + SessionStore | `IN_REVIEW` | `B2`, `R0`, `H1` | `08f0362` + `d06db38`；共享projection、socket/store、resume/at-most-once、Provider与最小UI；Client140；全仓门禁PASS，等待GPT验证 |
...
5. C1已集成main并完成全仓门禁，等待GPT独立验证；最终由X1验收M2
```
