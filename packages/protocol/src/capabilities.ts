 ...
 * surface advertises independent read tokens. `models.configure` is the
 * global, gate-protected models.json editor capability and is advertised only
 * while the dedicated mutation seam is mounted; skills/plugins remain
 * read-only. Trust state remains an internal gate for resource visibility.
 *
